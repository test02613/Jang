   ...
   <div class="wrapper">
      ...
      <h1>review</h1>
         <table class="table" >
            ...
            <tbody>
                  <tr >
                     <td id="title" style="text-decoration: none;"><c:out value="${detail.reviewnum}" /></td>
                     <td  ><c:out value="${detail.reviewtitle}" /></td>
                     <td style="text-decoration: none;"><c:out value="${detail.reviewdate}" /></td>
                  </tr>
               <tr >
                  <td colspan="3" height="500" scope="col"><c:out value="${detail.reviewcontent}" /></td>
               </tr>
