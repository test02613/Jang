		...
		<footer id="footer">
			...
			<div id="twitter">
				<a href="https://twitter.com/"><img
					src="../resources/img/twitter.png " width="40px" height="40px" /></a>
			</div>
			<div id="facebook">
				<a href="https://www.facebook.com/"><img
					src="../resources/img/face.png" width="40px" height="40px" /></a>
			</div>
			<div id="insta">
				<a href="https://www.instagram.com/"><img
					src="../resources/img/insta.png" width="40px" height="40px" /></a>
			</div>
		</footer>
	</div>
