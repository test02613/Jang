...
public class AdminController {
	...
	public String memberAdminGET(Model model) throws Exception {
	...
	public String memberBlack(MemberVO vo, Model model, String id) throws Exception {
		logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  진입");
	...
	public String blackReturn(MemberVO vo, Model model, String id) throws Exception {
		logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  진입");
	...
	public String reviewAdminDeleteAction(Integer reviewnum) throws Exception {
		logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 리뷰관리 페이지 진입");
	...
	public String qnaAdminGET() throws Exception {
		logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 관리자 페이지 진입");
	...
	public String itemAdmin() throws Exception {
		logger.info(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 관리자 페이지 진입");
	...
	public String itemInsert(Model model, ItemVO vo, Integer num) throws Exception {
	...
	public String itemupdateActionGET(ItemVO vo, Integer num) throws Exception {
	...
	public String itemselectGET(Model model, ItemVO vo, Integer num) throws Exception {
	...
	public String attrlistGET(Model model, ItemAttrVO attr, Integer num) throws Exception {
	...
	public String itemattrInsert(Model model, ItemVO vo, Integer num, Integer code, ItemAttrVO attr) throws Exception {
	...
	public String attrUpdateGET(ItemAttrVO attr) throws Exception {
	...
	public String itemDeleteActionGET(Integer itemnum) throws Exception {
	...
	public String attrDeleteActionGET(Integer itemcode, Integer num) throws Exception {
