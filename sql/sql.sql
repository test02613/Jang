...
--------------------------------------------------------
	CREATE TABLE ITEM (
	  ...
	  CATEGORY1	NUMBER    
	   ...
	   COMMENT ON COLUMN ITEM.CATEGORY2 IS '카테고리2';
	   COMMENT ON COLUMN ITEM.ITEMIMG IS '썸네일'; 
	   COMMENT ON COLUMN ITEM.ITEMDETAILIMG IS '상세이미지';
	   COMMENT ON COLUMN ITEM.CATEGORY1 IS '카테고리1';
...
--------------------------------------------------------   
	CREATE TABLE ITEMATTR (
	  ...
	  ITEMGB	VARCHAR(20)
	   ...
	   COMMENT ON COLUMN ITEMATTR.ITEMCOLOR IS '컬러';
	   COMMENT ON COLUMN ITEMATTR.ITEMGB IS '용량';
...
--------------------------------------------------------
	CREATE TABLE CART(
	  ...
	  ITEMATTR	VARCHAR(200), 
	   ...
	   COMMENT ON COLUMN CART.ITEMATTR IS '상품속성';
