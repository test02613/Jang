         ...
         <input type="hidden" name="map" value="${map }"> --%>
				...
				<table class="table table-striped">
					...
					<c:forEach var="list" items="${list}">
						<tbody>
							...
							<tr>
								<td><img src="${list.itemimg}" width="70px" height="70px">
								</td>
								<td style="width: 60px;"><a href="">${list.itemname}</a> <br>

								</td>
								<td style="text-align: center"><input type="text"
									value="${list.itemoption}"
									style="width: 80px; text-align: right; border: none;" readonly>
									<input type="hidden" name="itemcode" value="${list.itemcode}"
									style="width: 80px; text-align: right; border: none;" readonly>
								</td>
								<td style="text-align: center"><input type="text"
									name="ordercost" value="${list.itemcost}"
			...
			<div class="table-responsive">
				<table class="table table-striped" style="width: 1140px">
					...
					<tr>
						<td>주문금액</td>
						<td style="text-align: right"><input type="text" name="ORDER_TOTAL_ORDER_PRICE" id="ORDER_TOTAL_ORDER_PRICE" value="" 
					...
					<tbody>
						<tr>
							...
							<td style="text-align: left"><input type="hidden" name="id"
								...
								type="text" name="name" id="ORDER_NAME" value="${member.name}"
			...
			<div style="text-align: center">
				...
				<br> <input type="button" name="all_order" value="장바구니"
					onClick="location.href='/cartOrderAction"> <input type="submit"
