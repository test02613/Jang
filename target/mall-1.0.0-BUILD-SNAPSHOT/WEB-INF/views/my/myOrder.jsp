		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td style="text-align: center"><a href="">${order.itemattrvo.itemname}/${order.itemattrvo.itemcolor}</a>
						<br></td>
					<td style="text-align: center"><input type="hidden"
						name="itemcode" value="${order.itemattrvo.itemcode}"
						style="width: 60px; text-align: right; border: none;" readonly>
					</td>
					<td style="text-align: center"><input type="text"
						name="ordercost" value="${order.ordercost}"
